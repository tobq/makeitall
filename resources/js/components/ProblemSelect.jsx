...
//
//         this._deviceSelect = new MultiSelect("Affected Device", deviceSelect, options, render, containsInsensitive);
//         this._softwareSelect = new MultiSelect("Affected Software", softwareSelect, options, render, containsInsensitive);
